...
devicePresent () {
    [ -e $TARGET_DEVICE ] || {echo "No such device node as $TARGET_DEVICE" ; return 1 ; }
    return 0
    }

getDeviceNum () {
    [ handleArgs -eq 1 ] || {echo "This command takes exactly one argument." ; return 1 ; }
    }
